...
public class TelaListaUsuarios extends javax.swing.JFrame {
    ...
    public TelaListaUsuarios(Usuario u) {
        initComponents();
        this.usuario = u;
    }
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        ...
        int resposta = JOptionPane.showConfirmDialog(null, "Deseja realmente excluir esse usuário? ");
        if (resposta == 0) {
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        if (id != -1) {
            Usuario us = UsuarioDAO.buscarPorId(id);

            if (us != null) {
                TelaUsuarioEditar ue = new TelaUsuarioEditar(us, this.usuario);
                ue.setVisible(true);
                this.dispose();
            } else {
    ...
    private DefaultTableModel montarTabela() {
        String[] colunas = {"ID", "NOME DO USUÁRIO", "SENHA", "TIPO"};
        ...
        if (tabela.getRowCount() == 0) {
            JOptionPane.showMessageDialog(null, "Nenhum usuário encontrado com esse nome!", "Busca", JOptionPane.INFORMATION_MESSAGE);
        }
    ...
    private DefaultTableModel montarTabelaBusca(String busca) {
        ...
        List<Usuario> lista = UsuarioDAO.buscarPorNomeUsuario(busca);
