...
public class TelaRelatorioVendas extends javax.swing.JFrame {
    ...
    public TelaRelatorioVendas(Usuario u) {
        initComponents();
        this.usuario = u;
    }
    ...
    String[] colunas = {"ID VENDA", "NOME DO PRODUTO", "QUANTIDADE VENDIDA", "DATA DA VENDA", "TOTAL"};
    ...
    private DefaultTableModel montarTabelaBusca(String nome) {
    VendaDAO vendaDAO = new VendaDAO();
    String[] colunas = {"ID VENDA", "NOME DO PRODUTO", "QUANTIDADE VENDIDA", "DATA DA VENDA", "TOTAL"};

    DefaultTableModel tabela = new DefaultTableModel(colunas, 0);
    List<Venda> lista = VendaDAO.buscarPorProdutoVenda(nome);
