...
public class TelaListaProdutos extends javax.swing.JFrame {
    ...
    public TelaListaProdutos(Usuario u) {
        initComponents();
        this.usuario = u;
        configurarAcesso();
    }
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(tfBuscar, javax.swing.GroupLayout.PREFERRED_SIZE, 390, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        TelaEditarProduto pe = new TelaEditarProduto(p, this.usuario);
        pe.setVisible(true);
        this.dispose();
    ...
    private void btnVoltarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVoltarActionPerformed
        TelaListas tp = new TelaListas(this.usuario);
        tp.setVisible(true);
        this.dispose();
    ...
    private DefaultTableModel montarTabela(){
        ...
        String[] colunas = {"ID", "NOME DO PRODUTO", "CATEGORIA", "PREÇO DE VENDA"};
    ...
    private int getPosicao() {
        ...
        if (posicao <= -1) {
            JOptionPane.showMessageDialog(null, "Selecione um item para excluir ou editar.");
        }
    ...
    private DefaultTableModel montarTabelaBusca(String busca) {
        ...
        List<Produto> lista = ProdutoDAO.buscarPorNomeProduto(busca);
